...
const AdminPolicyForm: React.FC = () => {
  ...
  const fetchPolicy = async () => {
    setLoading(true);
    try {
      const res = await getPolicy("privacy", "ko");
  ...
  return (
    <div className="container-fluid">
      <div className="btn-group mb-3">
        <Link className="btn btn-primary" to="/AdmMaster/policy">개인정보처리방침</Link>
        <Link className="btn btn-secondary" to="/AdmMaster/consent">개인정보수집·이용동의</Link>
      </div>
